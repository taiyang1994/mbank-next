...
Picker.prototype.init = function () {
  ...
  self.itemAngle = parseInt(self.calcAngle(self.itemHeight));
...
Picker.prototype.setAngle = function (angle) {
  ...
  self.list.style.webkitTransform = 'perspective(100000px) rotateY(0deg) rotateX(' + angle + 'deg)';
...
/**
 * 弹出选择列表插件
 * 此组件依赖 listpcker ，请在页面中先引入 diesel.picker.css + diesel.picker.js
 * varstion 1.0.1
 * by Houfeng
 * Houfeng@DCloud.io
 */
...
var pickerBuffer = `<div class="diesel-picker">
  <div class="diesel-picker-mask-top"></div>
  <div class="diesel-picker-mask-bottom"></div>
  <div class="diesel-picker-inner">
    <ul class="diesel-pciker-list">
    </ul>
  </div>
</div>`;
...
var PopPicker = $.PopPicker = $.Class.extend({
  ...
  _createPicker: function () {
    ...
    for (var i = 1; i <= layer; i++) {
      ...
      var picker = $(pickerElement).picker({isolated: self.options.isolated});
  ...
  setData: function (data) {
    ...
    var layer = parseInt(this.options.layer, 10);
    if (!this.options || !this.options.layer || layer === 1) {
  ...
  setSelectedValues(values) {
    this.pickers.forEach((picker, index) => {
      picker.setSelectedValue(values[index]);
    });
  },
  setSelectedIndexes(indexes) {
    this.pickers.forEach((picker, index) => {
      picker.setSelectedIndex(indexes[index]);
    });
  },
  // 显示
...
var domBuffer = `<div class="diesel-dtpicker" data-type="datetime">
  ...
  <div class="diesel-dtpicker-body">
    ...
    <div data-id="picker-m" class="diesel-picker">
      <div class="diesel-picker-mask-top"></div>
      <div class="diesel-picker-mask-bottom"></div>
      <div class="diesel-picker-inner">
        <ul class="diesel-pciker-list">
    ...
    <div data-id="picker-d" class="diesel-picker">
      <div class="diesel-picker-mask-top"></div>
      <div class="diesel-picker-mask-bottom"></div>
      <div class="diesel-picker-inner">
        <ul class="diesel-pciker-list">
    ...
    <div data-id="picker-h" class="diesel-picker">
      <div class="diesel-picker-mask-top"></div>
      <div class="diesel-picker-mask-bottom"></div>
      <div class="diesel-picker-inner">
        <ul class="diesel-pciker-list">
    ...
    <div data-id="picker-i" class="diesel-picker">
      <div class="diesel-picker-mask-top"></div>
      <div class="diesel-picker-mask-bottom"></div>
      <div class="diesel-picker-inner">
        <ul class="diesel-pciker-list">
...
var DtPicker = $.DtPicker = $.Class.extend({
  init: function (options) {
    ...
    if (options && options.canBePermanent !== true) {
      $('[data-id="btn-permanent"]', _picker)[0].style.display = 'none';
    }
    ...
    var ui = self.ui = {
      ...
      permanent: $('[data-id="btn-permanent"]', _picker)[0],
    ...
    ui.permanent && ui.permanent.addEventListener('click', function () {
    ...
    ui.mask[0].addEventListener('click', function () {
      self.hide();
    }, false);
    ...
    switch (type) {
      case 'datetime':
        selected.value = selected.y.value + '-' + selected.m.value + '-'
          + selected.d.value + ' ' + selected.h.value + ':' + selected.i.value;
        selected.text = selected.y.text + '-' + selected.m.text + '-'
          + selected.d.text + ' ' + selected.h.text + ':' + selected.i.text;
        break;
      case 'date':
  ...
  _isBeginYear: function () {
    return this.options.beginYear === parseInt(this.ui.y.picker.getSelectedValue(), 10);
  },
  _isBeginMonth: function () {
    return this.options.beginMonth && this._isBeginYear()
      && this.options.beginMonth === parseInt(this.ui.m.picker.getSelectedValue(), 10);
  },
  _isBeginDay: function () {
    return this._isBeginMonth() && this.options.beginDay === parseInt(this.ui.d.picker.getSelectedValue(), 10);
  },
  _isBeginHours: function () {
    return this._isBeginDay() && this.options.beginHours === parseInt(this.ui.h.picker.getSelectedValue(), 10);
  },
  _isEndYear: function () {
    return this.options.endYear === parseInt(this.ui.y.picker.getSelectedValue());
  },
  _isEndMonth: function () {
    return this.options.endMonth && this._isEndYear()
      && this.options.endMonth === parseInt(this.ui.m.picker.getSelectedValue(), 10);
  },
  _isEndDay: function () {
  ...
  _createDay: function (current) {
    ...
    if (options.customData.d) {
      ...
      var maxDay = self._isEndMonth() ? options.endDay
        : self.getDayNum(
          parseInt(this.ui.y.picker.getSelectedValue(), 10),
          parseInt(this.ui.m.picker.getSelectedValue(), 10)
        );
      for (; d <= maxDay; d++) {
